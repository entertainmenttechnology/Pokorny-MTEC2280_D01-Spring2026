...
The time has arrived! Our final weeks of the semester will focus on final projects, driven by you. These Physical Computing projects will move through the following key (sometimes overlapping) phases:   
* initial proposal
...
NOTE: You may use another software application besides P5.JS that sends/receives data via Serial UART (for example, Unity, Processing, Max/MSP, etc.)  
...
_**Send proposals before class on 4/29 via Discord or Email, as a PDF labeled as YourName_FinalProjectProposal.PDF.**_      
  
## Final Deliverables (**Due Wednesday 5/20**): 
...
* At least 80% of the code from the project must be your own original code and ideas.   
   
## Important Dates   
* 4/29 - Project proposal due 
* 5/6 - WIP 1 due
* 5/13 - WIP 2 due
* 5/20 - Projects due / critiques / final deliverables due  
...
_For soldering outside of class, check [OpenLab hours](https://openlab.citytech.cuny.edu/mtecconnect/calendar/) for the V-102 Digital Fabrication Lab_   

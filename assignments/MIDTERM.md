...
## WORK-IN-PROGRESS: DUE 3/4

## MIDTERM: DUE 3/11

Create a physical computing system that accepts user input, is processed on the MicroController, and provides output to the user via actuators and indicators. 
...
### Wednesday 3/4 - MIDTERM WIP DUE
- The project should at least compile without errors, and circuits should be tested. 
